...
1. Update `data/prd.json` with `status: "merged"`
...
This check is documented in **data/progress.txt → Codebase Patterns** section (first item) so every iteration sees it immediately.
